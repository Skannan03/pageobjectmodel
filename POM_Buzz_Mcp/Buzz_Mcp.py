...
class Buzz_mcp(Basepage):
    mcp = (By.XPATH, "//button[normalize-space()='Most Commented Posts']")
    ...
    click_yes = (By.XPATH, "//button[@class='oxd-button oxd-button--medium oxd-button--label-danger orangehrm-button-margin']")
    ...
    def mostcommentedpost(self):
        self.hrm_btn_click(self.mcp)
